...
# mmm
curl -sO http://rpmfind.net/linux/epel/6/SRPMS/Packages/m/mysql-mmm-2.2.1-3.el6.src.rpm
rpm -i mysql-mmm-2.2.1-3.el6.src.rpm
...
/bin/cp -f /usr/local/src/build/centos6/mmm_multi_source.patch $RPMBUILDROOT/SOURCES/
